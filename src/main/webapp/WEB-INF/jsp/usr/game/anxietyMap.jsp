...
<c:set var="pageTitle" value="anxietyMap" />
...
<div class="map-container" id="mapContainer">
	...
	<!-- 배경 이미지 -->
	<img id="mapImage" src="/resource/img/불안의맵.png" alt="map" />

	<!-- 마스킹 캔버스 -->
	<canvas id="mapCanvas" width="5055" height="3904"></canvas>
	<img id="anxiety_portal" class="anxiety_portal" src="/resource/img/불안의맵마법진.png" />
...
<script type="module">
	...
	const currentMapName = "anxietyMap";
